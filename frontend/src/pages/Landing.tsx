              ...
              <div className="grid gap-16 lg:grid-cols-12 lg:items-start lg:gap-12">
                ...
                <div className="lg:col-span-6 lg:pb-8">
                  ...
                  <p className="mt-8 max-w-lg text-[1.05rem] leading-[1.85] text-muted-foreground">
                    ...
                    SMYP détecte les anomalies, extrait les données clés et
                    génère un rapport complet — sans friction ni installation.
                  </p>
            ...
            <div className="mx-auto max-w-6xl">
              <div className="mb-16 max-w-lg">
                ...
                <p className="mt-5 text-sm leading-7 text-muted-foreground">
                  OCR, contrôle documentaire et détection d'incohérences
                  travaillent ensemble pour produire un résultat lisible
                  immédiatement.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-5xl font-semibold tracking-[-0.04em] text-foreground">
                    Analysez votre premier
                    <br />
                    document gratuitement.
                  </h2>
                  <p className="mt-6 text-sm leading-7 text-muted-foreground">
                    Aucune carte bancaire requise. Déposez un fichier et obtenez
                    votre analyse complète en quelques secondes.
                  </p>
                </div>

                <Button onClick={scrollToUpload} variant="default" size="lg">
        ...
        <footer className="border-t border-border/60 px-6 py-8 lg:px-8">
          <div className="mx-auto flex max-w-6xl flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="text-xs text-muted-foreground">
              © 2026 SMYP — Tous droits réservés
            </p>
          </div>
        </footer>
      </div>
