                ...
                {documents.map((doc) => (
                  <button
                    ...
                    className={`w-full p-4 flex items-center gap-3 hover:bg-neutral-50 transition-colors text-left ${
                      selectedDoc?.id === doc.id ? "bg-neutral-50" : ""
                    }`}
                  >
                    <button
                      onClick={(e) => {
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md text-center">
          ...
          <div 
            ...
            className={`bg-white rounded-2xl p-8 shadow-sm border-2 border-dashed mb-6 transition-all duration-200 ${
              !isLoggedIn 
          ...
          >
            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-colors ${
              isDragging ? "bg-neutral-900" : "bg-neutral-100"
            }`}>
